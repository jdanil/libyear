...
import { getInferredPackageManager, getParsedPackageManager } from "./package-manager";
...
export const cli = async () => {
  ...
  libyear(getParsedPackageManager(args["package-manager"] ?? await getInferredPackageManager()), {
